...
import contactBg from "../assets/images/contact.jpg"; // Import de l'image de fond
...
const ContactForm = () => {
  ...
  return (
    <>
      ...
      <div className="relative w-full min-h-screen flex items-center justify-center py-12 px-6 bg-gray-100">
        {/* Image de fond */}
        <div
        ...
        {/* Formulaire */}
        <div className="relative z-20 max-w-3xl w-full bg-white rounded-2xl shadow-xl p-12 animate-slideUp">
